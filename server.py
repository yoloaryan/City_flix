...
# ==============================================================================
# Serialization Helpers for LangChain Messages
# ==============================================================================
...
# ==============================================================================
class CityflixHandler(SimpleHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if parsed.path == "/api/chat":
            ...
            try:
                ...
                self._send_json({"error": f"LLM invocation error: {str(e)}"}, status=500)
                return
        ...
        # 2. /api/approve: Human-in-the-Loop decision execution
        if parsed.path == "/api/approve":
            ...
            # Feed ToolMessage back to LLM to synthesize final answer
            ...
            # Check if there is another chained tool call
...
# ==============================================================================
def run_server():
    server = ThreadingHTTPServer(("0.0.0.0", PORT), CityflixHandler)
    print(f"🎬 Cityflix Server running at http://localhost:{PORT}")
